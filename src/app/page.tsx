...
const Page = () => {
	return (
		<main className='min-h-screen flex flex-col justify-center items-center'>
			<section className='text-center max-w-xl px-6 py-12 bg-opacity-80 rounded-xl shadow-lg border-1 border-gray-400'>
				...
				<p className='text-lg md:text-xl text-gray-400 mb-8'>
					...
					<br />
					Stay organized, productive, and focused with your personal todo
					dashboard.
				</p>
				<Link href='/dashboard'>
					<Button
